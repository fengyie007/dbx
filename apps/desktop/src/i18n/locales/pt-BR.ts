...
export default withEnglishFallback({
  ...
  structureEditor: {
    ...
    dorisTableModel: "Modelo da tabela",
    dorisKeyColumn: "Coluna chave",
    dorisReplicationNum: "Réplicas",
    dorisReplicationNumPlaceholder: "Padrão do cluster",
    dorisAggregationType: "Agregação",
    dorisAggregationTypePlaceholder: "Selecionar agregação",
    owner: "Proprietário",
