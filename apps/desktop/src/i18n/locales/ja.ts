...
export default withEnglishFallback({
  ...
  structureEditor: {
    ...
    dorisTableModel: "テーブルモデル",
    dorisKeyColumn: "キー列",
    dorisReplicationNum: "レプリカ数",
    dorisReplicationNumPlaceholder: "クラスターの既定値",
    dorisAggregationType: "集約タイプ",
    dorisAggregationTypePlaceholder: "集約タイプを選択",
    owner: "所有者",
