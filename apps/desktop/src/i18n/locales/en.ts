...
export default {
  ...
  structureEditor: {
    ...
    dorisTableModel: "Table model",
    dorisKeyColumn: "Key column",
    dorisReplicationNum: "Replicas",
    dorisReplicationNumPlaceholder: "Cluster default",
    dorisAggregationType: "Aggregation",
    dorisAggregationTypePlaceholder: "Select aggregation",
    owner: "Owner",
